...
חוקים:
- אל תמציא מידע.
- אל תוסיף המלצות לנציג.
- אל תוסיף פרטים חסרים.
- אל תשאל שאלות.
- אם פרט לא נאמר, כתוב "לא נמסר".
- הדחיפות תהיה "דחופה" רק אם הלקוח אמר במפורש שמדובר בתקלה דחופה או שאין שירות. אחרת כתוב "רגילה".
